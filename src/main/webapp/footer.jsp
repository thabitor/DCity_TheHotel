        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                ...
                <ul class="list-unstyled">
                    <li><a href="/Hotel/rooms/rooms-tariff.jsp">Rooms & Tariff</a></li>
                    <li><a href="/Hotel/introduction.jsp">Introduction</a></li>
                    <li><a href="/Hotel/gallery.jsp">Gallery</a></li>
                    <li><a href="/Hotel/tour.jsp">Tour Packages</a></li>
...
<!-- boostrap -->
<script src="/Hotel/assets/bootstrap/js/bootstrap.js" type="text/javascript"></script>
<!-- jquery mobile -->
